...
export const WRITE_MATRIX: Record<EventTable, string[]> = {
  ...
  crop_inputs: ["worker","team_lead","tech_head","director"], harvests: ["worker","team_lead","tech_head","director"], pos_receipts: ["worker","team_lead","director","accountant"], hosp_folio: ["worker","team_lead","director","accountant"],
};
