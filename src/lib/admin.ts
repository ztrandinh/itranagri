...
export const ADMIN_TABLES: AdminTable[] = [
  ...
  { table: "mkt_campaigns", pk: "id", label: "Marketing · chiến dịch", group: "Kinh doanh", farmScoped: true, softDelete: null, writeRoles: ["owner", "director", "tech_head", "team_lead", "it_engineer"] },
  ...
  { table: "qc_holds", pk: "id", label: "QC · giữ lô không đạt (chặn xuất bán)", group: "Chất lượng", farmScoped: true, softDelete: null, writeRoles: ["owner", "director", "tech_head", "auditor", "it_engineer"] },
  ...
  { table: "api_keys", pk: "id", label: "Khóa API (IoT ingest / tích hợp)", group: "Tích hợp", farmScoped: true, softDelete: null, writeRoles: ["owner", "it_engineer"], hidden: ["key_hash", "hmac_secret_enc"] },
