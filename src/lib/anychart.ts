...
export const ANY_TABLES: AnyTable[] = [
  ...
  { table: "device_readings", label: "Đọc đồng hồ nhà công năng (điện/nước/nhiệt theo chỉ số)", ts: "ts" },
  ...
  { table: "kpi_results", label: "KPI nhân sự", ts: "month" },
  ...
  { table: "v_group_egg_daily", label: "Gà đẻ theo ĐÀN — trứng/ngày · tỷ lệ đẻ % · mái", ts: "ts" },
  { table: "v_group_egg_month", label: "Gà đẻ theo ĐÀN/tháng — trứng · cám · cám/quả trứng", ts: "ts" },
  { table: "v_group_growth_month", label: "Tăng trưởng theo ĐÀN/tháng (FCR·ADG·cân TB — so lứa bò/dê)", ts: "ts" },
  { table: "v_staff_task_daily", label: "Năng suất nhân sự — việc xong/ngày · % đúng hạn", ts: "ts" },
