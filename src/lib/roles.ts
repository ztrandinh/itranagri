...
export const PAGE_ROLES: Record<string, string[]> = {
  ...
  "/gd": ["owner", "director", "auditor", "it_engineer"], "/xnk": MGMT_ROLES, "/rd": MGMT_ROLES, "/nhan-rong": ["owner", "director", "it_engineer"], "/mua-hang": [...MGMT_ROLES, "team_lead", "worker"], "/giam-sat": [...MGMT_ROLES, "team_lead"],
};
export const _x = 0;
