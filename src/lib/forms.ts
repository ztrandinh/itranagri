    ...
    animal_event: {
      ...
      fields: [
        { key: "event_type", label: "Loại sự kiện", type: "choice", required: true, options: [
          ...
          { id: "CAN", label: "Cân" }, { id: "BCS", label: "Thể trạng BCS (1–5)" }, { id: "LAME", label: "Chấm QUÈ 0–3 (≥2 báo thú y — bò đau = giảm ăn, giảm đậu thai; ghi sớm cứu con + tiền)" }, { id: "VAT_SUA", label: "Vắt sữa (kg)" }, { id: "AN_THUA", label: "Ăn thừa (kg)" }, { id: "TAY_KY_SINH", label: "Tẩy ký sinh" }, { id: "BENH", label: "Bệnh nghi" }, { id: "DIEU_TRI", label: "Điều trị" }, { id: "VACCINE", label: "Vaccine" }, { id: "CHUYEN", label: "Chuyển chuồng" }, { id: "CHET", label: "Chết" }, { id: "GHI_CHU", label: "Ghi chú" }] },
        { key: "value", label: "Giá trị (kg cân / BCS 1–5 / QUÈ 0–3 / kg sữa / số liều …)", type: "number", step: 0.5, min: 0 },
      ...
      build: (t, v) => {
        ...
        return { ...rest, event_type: et, unit: et === "CAN" || et === "VAT_SUA" || et === "AN_THUA" ? "kg" : et === "BCS" || et === "LAME" ? "diem" : et === "VACCINE" || et === "DIEU_TRI" || et === "TAY_KY_SINH" ? "lieu" : null, detail, withdrawal_until: et === "DIEU_TRI" || et === "VACCINE" ? wd : null };
      },
    },
