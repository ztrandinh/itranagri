...
function Whistle() {
  ...
  if (!open) return <div className="text-xs text-muted">🛡 Thấy bao che, gian dối, lười biếng, mất an toàn? <button className="underline" onClick={() => setOpen(true)}>Phản ánh ẩn danh tới Chủ tịch/TGĐ</button> — hệ thống KHÔNG lưu người gửi.</div>;
