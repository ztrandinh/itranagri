...
function Whistle() {
  ...
  if (!open) return <div className="text-xs text-muted">🛡 Thấy bao che, gian dối, lười biếng, mất an toàn? <button className="underline py-2 -my-2" onClick={() => setOpen(true)}>Phản ánh ẩn danh tới Chủ tịch/TGĐ</button> — hệ thống KHÔNG lưu người gửi.</div>;
  return <div className="card text-sm space-y-2"><b>🛡 Phản ánh ẩn danh</b> <span className="text-xs text-muted">— chỉ Chủ tịch/TGĐ/GĐ đọc; không lưu tên/ID người gửi (chỉ băm chống spam, tối đa 5 lượt/tuần)</span>
