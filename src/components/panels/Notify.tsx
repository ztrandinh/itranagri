...
export function AlertSettings({ sess }: { sess: Sess }) {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="card p-0 overflow-auto"><div className="px-3 py-2 font-bold bg-surface-2 rounded-t-2xl">Danh mục luật (có phiên bản, có vết ai sửa)</div><table className="tbl"><thead><tr><th className="pl-3">Mã</th><th>Tên</th><th>Loại</th><th>Mức</th><th>Người nhận</th><th>Kênh</th><th>Phạm vi</th><th className="text-right">Đã nổ</th><th>TT</th></tr></thead><tbody>
