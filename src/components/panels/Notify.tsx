...
export function Bell() {
  ...
  return (<div className="relative">
    <button className={`rounded-full px-2.5 py-0.5 text-sm font-semibold ${n ? "bg-red-500 text-white" : "bg-green-600"}`} onClick={() => { setOpen(!open); void load(); }} title="Thông báo">🔔 {n || ""}</button>
