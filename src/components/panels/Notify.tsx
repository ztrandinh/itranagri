...
export function Bell() {
  ...
  return (<div className="relative">
    <button className={`rounded-full px-2.5 py-1 text-xs font-semibold ${n ? "bg-red-500 text-white" : "bg-slate-100 text-slate-700"}`} onClick={() => { setOpen(!open); void load(); }} title="Thông báo">🔔 {n ? (n > 99 ? "99+" : n) : ""}</button>
