...
export default function KhoPanel({ sess }: { sess: Sess }) {
  ...
  const [tab, setTab] = useState<"ton" | "ghi" | "kiemke" | "so" | "bieudo">("ton"); const [form, setForm] = useState("stock_in"); const [sku, setSku] = useState<string | null>(null); const [openSku, setOpenSku] = useState<string | null>(null);
