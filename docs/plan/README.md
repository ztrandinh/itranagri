# ITRAN AGRI — BỘ KẾ HOẠCH PHÁT TRIỂN PHẦN MỀM (v1.0 · 18/08/2026)
...
**Hai đường ray (theo Góp ý v1.5):** Ray A = `files/itran-agri-starter` (Supabase + Next.js PWA) cho 90 ngày thực chiến; Ray B = bộ 10 file này làm bản đồ đích, mở khi ≥3 trại / ≥3 khách trả tiền / cần IoT thời gian thực. Bảng RC chuẩn duy nhất: file 06 §3 (RC11 = giấy–số).
